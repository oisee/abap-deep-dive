...
- **Статус**: 🔴 Требует доработки
- **Критические проблемы**:
  1. Неверный номер порта диспетчера (32XX вместо 32NN)
  2. Отсутствует информация о платформенных различиях (Unix/Windows)
  ...
  7. Отсутствует время выполнения диалогового шага (600 сек)
  8. Некорректное описание Database Interface
- **Основные TODO**: Добавить все типы WP, метрики производительности, полные примеры кода, PRIV mode