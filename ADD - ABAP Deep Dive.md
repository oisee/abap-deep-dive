...
1. [[ADD - Глава 1  Анатомия SAP системы]]
2. [[ADD - Глава 2 Ядро SAP - операционная система бизнес-приложений]] 
3. [[ADD - Глава 3 Work Process - микрокосм выполнения]]
4. [[ADD - Глава 4 Иерархия памяти - балансировка между масштабируемостью и выживанием]]
5. [[ADD - Глава 5 ABAP Virtual Machine - от исходника к исполнению]]
6. [[ADD - Глава 6 Database Interface - мост между ABAP и СУБД]]
7. [[ADD - Глава 7 От R2 до S4HANA - архитектурные революции]]
8. [[ADD - Глава 8 SAP HANA - больше чем база данных]]
9. [[ADD - Глава 9 SADL и Gateway - автоматизация REST API]]
10. [[ADD - Глава 10 От BOPF к RAP - эволюция бизнес-объектов]]
11. [[ADD - Глава 11 ABAP Daemons и Channels - реактивная архитектура]]
12. [[ADD - Глава 12 Инструменты анализа - заглядываем внутрь]]