...
CHAPTERS = [
    ...
    "ADD - Глава 11.2 Фреймворки фоновой обработки ABAP - эволюция асинхронности.md",
    "ADD - Глава 12 Инструменты анализа - заглядываем внутрь.md",
    "ADD - Глава 13 Performance Tuning - искусство оптимизации.md",
    "ADD - Приложение А Заглушка про то что не все проверено и где взять настоящую документацию.md",
    "ADD - Приложение Б Фактчекинг книги детальный отчёт о проверке технических фактов.md",
    "ADD - Приложение В История исправлений подробный журнал примененных патчей и улучшений.md",
    "ADD - Приложение Г Критический анализ книги.md"
]
